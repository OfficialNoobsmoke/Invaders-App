...
const CharacterDetails = () => {
  ...
  const [isCharacterNameReadOnly, setIsCharacterNameReadOnly] = useState(true);
  const [isRealmServerReadOnly, setIsRealmServerReadOnly] = useState(true);
    ...
    <Container maxWidth="md">
      <Stack spacing={2}>
        ...
        <TextFieldWrapper
          ...
          onChangeHandler={characterNameInputHandler}
          slotProps={{
            input: {
              readOnly: isCharacterNameReadOnly,
              endAdornment: (
                <InputAdornment position="start">
                  {isGetCharacterDataFromExternalSourceLoading && <CircularProgress />}
                </InputAdornment>
              ),
            },
          }}
